...
import com.beta.android.aakashresearchlabs.test.TestFragment.OnListFragmentInteractionListener;
...
public class MyTestRecyclerViewAdapter extends RecyclerView.Adapter<MyTestRecyclerViewAdapter.ViewHolder> {
    ...
    public MyTestRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
